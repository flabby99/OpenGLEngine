...
layout (location = 1) mat4 view_proj;
...
void main()
{
  ...
  vec3 refracted = refract(light_direction, texture(producer_norm_tex, vPosition * 0.5 + vec2(0.5)).rgb, ratio);
