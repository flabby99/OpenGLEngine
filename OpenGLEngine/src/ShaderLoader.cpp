...
char* core::ShaderLoader::ReadShader(char * filename)
{
...
GLuint core::ShaderLoader::CreateShader(GLenum shadertype, const char* shadercode)
{
...
GLuint core::ShaderLoader::CreateProgram(char ** filenames)
{
	GLint success = 0;
